...
export const FAQ = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-stone-950 to-stone-900/50 transition-colors duration-500 relative">
      {/* Decorative pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(6, 182, 212,0.04),transparent_60%)]" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <p className="text-cyan-500 uppercase tracking-[0.3em] text-xs font-bold mb-4">{t('faq.subtitle')}</p>

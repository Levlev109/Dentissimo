            ...
            <div className="p-4 bg-stone-900 border-t border-stone-700">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 border border-stone-600 bg-stone-800 text-white placeholder-stone-500 focus:ring-2 focus:ring-cyan-400 focus:border-transparent outline-none text-sm"
                />
                <button
                  onClick={handleSend}

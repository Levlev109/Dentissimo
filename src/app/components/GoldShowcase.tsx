...
const themes: Record<string, { color: string; glow: string; gradient: string }> = {
  ...
  'diamond':          { color: '#2dd4bf', glow: 'rgba(45,212,191,0.15)',  gradient: 'from-teal-950/40 via-stone-950 to-stone-950' },
  ...
  'brush-medium':     { color: '#2dd4bf', glow: 'rgba(45,212,191,0.15)', gradient: 'from-teal-950/40 via-stone-950 to-stone-950' },
  'brush-hard':       { color: '#64748b', glow: 'rgba(100,116,139,0.15)',gradient: 'from-slate-950/50 via-stone-950 to-stone-950' },
  'brush-sensitive':  { color: '#2dd4bf', glow: 'rgba(45,212,191,0.15)', gradient: 'from-teal-950/40 via-stone-950 to-stone-950' },

...
const ProductCard = ({ product, index, accent }: { product: LineProduct; index: number; accent: 'pro' | 'premium' }) => {
  ...
  const gradients = {
    pro: 'from-stone-800/60 via-stone-800 to-stone-800/60',
    premium: 'from-stone-800/60 via-stone-800 to-stone-800/60',
  };
  const borderColors = {
    pro: 'border-teal-800/30 hover:border-teal-700',
    premium: 'border-amber-800/30 hover:border-amber-700',
  };
  const badgeBg = {
    pro: 'bg-teal-900/30 text-teal-300 border-teal-800/40',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          >
            ...
            <p className="text-stone-400 mb-6 pl-[52px]">
        ...
        >
          <a
            href="#products"
            className="inline-flex items-center gap-2 px-8 py-4 bg-white text-stone-900 font-semibold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transform transition-all duration-300 hover:bg-stone-100"
          >

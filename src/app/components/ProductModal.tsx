      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            style={{ maxWidth: 960, backgroundColor: '#0f1419', borderRadius: 0 }}
            onClick={(e) => e.stopPropagation()}
          >
            {/* ═══ TOP BAR ═══ */}
            <div className="flex items-center h-[52px] px-4 md:px-6 shrink-0" style={{ borderBottom: '1px solid #1e262e', ...sans }}>
              {/* Logo */}
              ...
              <span className="ml-1.5 text-[8px] tracking-[0.18em] uppercase hidden md:inline" style={{ color: '#64748b' }}>
                Premium Oral Care
              </span>
                  ...
                  return (
                    <button key={tab.key} onClick={() => setActiveTab(tab.key)}
                      ...
                      style={{
                        ...
                        backgroundColor: active ? '#161c22' : 'transparent',
                        border: active ? '1px solid #2e3842' : '1px solid transparent',
                        borderRadius: 5,
              ...
              <button onClick={onClose}
                className="ml-2 w-[30px] h-[30px] flex items-center justify-center rounded-full hover:bg-white/10 shrink-0"
                style={{ color: '#94a3b8' }}>
                <X size={14} />
              </button>
            </div>
                  ...
                  <div className="flex flex-col md:flex-row" style={{ minHeight: 520 }}>
                    ...
                    <div className="md:w-[45%] flex flex-col items-center justify-center p-10 md:p-12 relative"
                      ...
                      <div className="absolute top-5 left-5 right-5 flex items-center justify-between">
                        <span className="text-[8px] tracking-[0.22em] uppercase font-semibold" style={{ color: '#64748b', ...sans }}>
                    ...
                    <div className="md:w-[55%] p-7 md:p-10 flex flex-col">
                      {/* Type label */}
                      <p className="text-[9px] tracking-[0.25em] uppercase mb-2" style={{ color: '#94a3b8', ...sans, fontWeight: 600 }}>
                        {typeLabel}
                      </p>

                      {/* Product name — large Cormorant Garamond */}
                      <h2 className="font-serif mb-6" style={{ fontSize: 38, fontWeight: 700, lineHeight: 1.08, color: '#f8fafc', letterSpacing: '-0.01em' }}>
                        {product.name}
                      </h2>

                      {/* h1 card with product thumbnail */}
                      <div className="flex items-start gap-3.5 p-4 mb-3"
                        style={{ backgroundColor: '#161c22', borderRadius: 14 }}>
                        ...
                        <p className="text-[14px] leading-[1.45] pt-0.5" style={{ color: '#e2e8f0', fontWeight: 700, ...sans }}>
                          {t(`modal.${product.id}.h1`)}
                        </p>
                      </div>

                      {/* h2 card */}
                      <div className="p-4 mb-5" style={{ backgroundColor: '#161c22', borderRadius: 14 }}>
                        <p className="text-[13px] leading-[1.6]" style={{ color: '#cbd5e1', ...sans }}>
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <p className="text-[12px] leading-[1.5]"
                          style={{ color: '#94a3b8', fontStyle: 'italic', ...sans }}>
                      ...
                      <div className="pt-3 space-y-2.5">
                        <div className="flex items-center justify-between">
                          <span className="font-serif" style={{ fontSize: 28, fontWeight: 700, color: '#f8fafc' }}>
                          ...
                          <div className="flex items-center gap-1" style={sans}>
                            <button onClick={() => setQuantity(q => Math.max(1, q - 1))}
                              ...
                              style={{ border: '1px solid #2e3842', color: '#94a3b8' }}>
                              <Minus size={13} />
                            </button>
                            <span className="w-8 text-center text-[13px]" style={{ fontWeight: 700, color: '#e2e8f0' }}>
                              {quantity}
                            </span>
                      ...
                      {/* Footer bar */}
                      {details?.volume && (
                        <div className="flex items-center justify-between mt-4 pt-3" style={{ borderTop: '1px solid #1e262e' }}>
                          <span className="text-[11px]" style={{ color: '#64748b', fontStyle: 'italic', ...sans }}>
                            {formulaLabel}
                          </span>
                          <span className="font-serif" style={{ fontSize: 20, fontWeight: 700, color: '#e2e8f0' }}>
                ...
                <motion.div key="benefits" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2 }}>
                  <div className="flex flex-col md:flex-row" style={{ minHeight: 520 }}>
                    ...
                    <div className="md:w-[58%] p-7 md:p-10 flex flex-col">
                      {/* Product name */}
                      <h2 className="font-serif mb-7" style={{ fontSize: 38, fontWeight: 700, lineHeight: 1.08, color: '#f8fafc' }}>
                        {product.name}
                      </h2>
                      ...
                      <div className="px-5 py-4 mb-7" style={{
                        ...
                        <p className="text-[14px] leading-[1.55]" style={{ color: '#e2e8f0', fontWeight: 700, ...sans }}>
                      ...
                      <div className="mb-7">
                        <div className="flex items-center gap-3 mb-4">
                          <div className="w-[10px] h-[10px] rounded-full shrink-0" style={{ backgroundColor: '#e2e8f0' }} />
                          <h3 className="font-serif" style={{ fontSize: 30, fontWeight: 700, color: '#f8fafc', lineHeight: 1.1 }}>
                            {t(`modal.${product.id}.bt2`)}
                          </h3>
                        </div>
                        {/* Tree branch items */}
                        <div className="ml-[5px]" style={{ borderLeft: '2px solid #2e3842', paddingLeft: 20 }}>
                          <div className="relative py-1.5">
                            <div className="absolute -left-[21px] top-[13px]" style={{ width: 16, height: 0, borderTop: '2px solid #2e3842' }} />
                            <p className="text-[13px] leading-[1.6]" style={{ color: '#cbd5e1', ...sans }}>
                      ...
                      <div className="flex items-center gap-4 mt-auto p-4" style={{
                        ...
                        <div>
                          <p className="text-[13px] leading-[1.2] mb-1" style={{ fontWeight: 700, color: '#e2e8f0', ...sans }}>
                            {t(`modal.${product.id}.bt3`)}
                          </p>
                          <p className="text-[12px] leading-[1.5]" style={{ color: '#cbd5e1', ...sans }}>
                            {t(`modal.${product.id}.b3`)}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="mt-6 pt-4" style={{ borderTop: '1px solid #1e262e' }}>
                        <span className="text-[9px] tracking-[0.2em] uppercase" style={{ color: '#64748b', ...sans, fontWeight: 600 }}>
                          Global Swiss Group
                        </span>
                      </div>
                    </div>
                ...
                <motion.div key="ingredients" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2 }}>
                  <div className="flex flex-col md:flex-row" style={{ minHeight: 520 }}>
                    ...
                    <div className="md:w-[62%] p-7 md:p-10">
                      <h2 className="font-serif mb-8" style={{ fontSize: 38, fontWeight: 700, lineHeight: 1.08, color: '#f8fafc' }}>
                      ...
                      {details?.ingredients && details.ingredients.length > 0 ? (
                        <div className="relative" style={{ paddingLeft: 2 }}>
                          ...
                          <div className="absolute" style={{ left: 9, top: 12, bottom: 12, width: 2, backgroundColor: '#2e3842' }} />
                            ...
                            {details.ingredients.map((ingredient) => (
                              <div key={ingredient} className="flex items-start gap-5 relative">
                                ...
                                <div className="shrink-0 relative z-10" style={{
                                  ...
                                  backgroundColor: '#e2e8f0', marginTop: 3,
                                  border: '4px solid #0f1419',
                                  boxShadow: '0 0 0 1px #2e3842',
                                }} />
                                <div style={{ flex: 1 }}>
                                  <p className="font-serif" style={{ fontSize: 22, fontWeight: 700, color: '#f8fafc', lineHeight: 1.15, marginBottom: 4 }}>
                                    {t(`ingredients.${ingredient}`)}
                                  </p>
                                  <p className="text-[12px] leading-[1.65]" style={{ color: '#cbd5e1', ...sans }}>
                        ...
                        <p className="text-[13px]" style={{ color: '#cbd5e1', ...sans }}>{product.description}</p>
                      )}
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div key="extra" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2 }}>
                  <div className="flex flex-col md:flex-row" style={{ minHeight: 520 }}>
                    ...
                    <div className="md:w-[58%] p-7 md:p-10">
                      {/* Title */}
                      <h2 className="font-serif mb-4" style={{ fontSize: 36, fontWeight: 700, lineHeight: 1.08, color: '#f8fafc' }}>
                        {t(extraKeys.dailyUse)}
                      </h2>

                      {/* Не содержит: flowing comma list */}
                      <p className="text-[13px] leading-[1.65] mb-7" style={{ color: '#cbd5e1', ...sans }}>
                        <span style={{ fontWeight: 700, color: '#e2e8f0' }}>{t('modal.noContainsTitle')}:</span>{' '}
                      ...
                      <div className="p-6 mb-7" style={{
                        ...
                        <p className="text-[13px] leading-[1.65]" style={{ color: '#cbd5e1', ...sans }}>
                      ...
                      {details?.composition && (
                        <div className="mb-5">
                          <h3 className="mb-1.5" style={{ fontSize: 14, fontWeight: 700, color: '#e2e8f0', ...sans }}>
                            {t('goldShowcase.compositionTitle')}
                          </h3>
                          <p className="text-[11px] leading-[1.7]" style={{ color: '#94a3b8', ...sans }}>
                            {details.composition}
                          </p>
                        </div>
                      )}
                      ...
                      {/* Storage */}
                      <div>
                        <h3 className="mb-1" style={{ fontSize: 14, fontWeight: 700, color: '#e2e8f0', ...sans }}>
                          {t('goldShowcase.storageTitle')}
                        </h3>
                        <p className="text-[11px] leading-[1.6]" style={{ color: '#94a3b8', ...sans }}>
